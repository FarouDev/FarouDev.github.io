...
function scrollToTarget(t, a) {
    var e = "slow";
    0 == t ? t = $(a).closest(".bloc").height() : 1 == t ? t = 0 : 2 == t ? t = $(document).height() : (t = $(t).offset().top, $(".sticky-nav").length && (t -= $(".sticky-nav").outerHeight())), $(a).is("[data-scroll-speed]") && (e = $(a).attr("data-scroll-speed"), parseInt(e) && (e = parseInt(e))), $("html,body").animate({
        scrollTop: t
...
function setUpClassToggle() {
    $(document).on("click", "[data-toggle-class-target]", function(t) {
        t.preventDefault();
        var a, e = $(this).attr("data-toggle-class-target"),
            o = $(this).attr("data-toggle-class");
        o.length && (-1 != e.indexOf(",") ? (a = e.split(","), $.each(a, function(t) {
            $("#" + a[t]).toggleClass(o)
        })) : $("#" + e).toggleClass(o), reCalculateParallax())
    })
}
